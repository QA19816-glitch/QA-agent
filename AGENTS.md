...
- For future Zentao bug titles, treat any leading `【...】` tag content as the default Codex automation marker; preserve that bracketed prefix as the title tag unless the user explicitly asks for a different marker.
