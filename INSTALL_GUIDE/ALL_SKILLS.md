...
1. `1password`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/1password>
2. `accessibility-testing`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   - 功能作用：无障碍测试技能，用于验证产品的可访问性、WCAG合规性、辅助技术支持等。当用户需要进行无障碍测试、合规检查、用户体验优化时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/accessibility-testing>
3. `acp-router`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Route plain-language requests for Pi, Claude Code, Codex, OpenCode, Gemini CLI, or ACP harness work into either OpenClaw ACP runtime sessions or direct acpx-driven sessions ("telephone game" flow). For coding-agent thread requests, read this skill first, then use only `sessions_spawn` for thread creation.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/acp-router>
4. `add-analytics`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/add-analytics>
5. `afrexai-qa-engine`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/afrexai-qa-engine>
6. `afrexai-qa-test-plan`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/afrexai-qa-test-plan>
7. `afrexai-qa-testing-engine`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   - 功能作用：End-to-end testing methodology for AI agents, covering strategy, execution, coverage, and reporting.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/afrexai-qa-testing-engine>
8. `afrexai-web-performance-engine`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/afrexai-web-performance-engine>
9. `agent-browser`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Secure Web Browser: control a real web browser to navigate websites, click elements, fill forms, take screenshots, extract content, and perform web automation tasks safely. Use when: the user wants to browse a website, fill out a web form, take a screenshot of a webpage, extract content from a site, automate web interactions, log into a website, or perform any action that requires a browser.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/agent-browser>
10. `agent-browser-clawdbot`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Headless browser automation CLI optimized for AI agents with accessibility tree snapshots and ref-based element selection
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/agent-browser-clawdbot>
11. `analytics-tracking-2`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/analytics-tracking-2>
12. `android-adb`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/android-adb>
13. `api-doc-generator`
   - 分类名称：测试技能类 / 其他测试相关
   - 功能作用：Automatically generate API documentation from code or interface definitions.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/api-doc-generator>
14. `api-performance-testing`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/api-performance-testing>
15. `api-testing`
   - 分类名称：测试技能类 / 接口测试 / API / Mock
   - 功能作用：API接口测试技能，用于验证RESTful API、GraphQL接口的功能性、性能和安全性。当用户需要进行接口测试、验证API响应、检查接口文档时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/api-testing>
16. `apple-notes`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/apple-notes>
17. `apple-reminders`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/apple-reminders>
18. `atlassian-confluence`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/atlassian-confluence>
19. `atlassian-jira`
   - 分类名称：非测试技能类 / 其他非测试相关
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/atlassian-jira>
20. `automate-excel`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/automate-excel>
21. `aws-infra`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/aws-infra>
22. `baidu-web-search`
   - 分类名称：非测试技能类 / 其他非测试相关
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/baidu-web-search>
23. `bear-notes`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Create, search, and manage Bear notes via grizzly CLI.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/bear-notes>
24. `best-prompts`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：通用高质量 Prompt 合集。覆盖论文写作、开发流程、PPT 生成、自媒体创作、项目文档与简历优化等场景，适合在不同任务中快速复用成熟 Prompt 模板。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/best-prompts>
25. `blogwatcher`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Monitor blogs and RSS/Atom feeds for updates using the blogwatcher CLI.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/blogwatcher>
26. `blucli`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：BluOS CLI (blu) for discovery, playback, grouping, and volume.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/blucli>
27. `bluebubbles`
...
29. `bug-investigation`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/bug-investigation>
30. `byte-rover`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：ByteRover Project Knowledge Management: build and query a persistent knowledge graph of your codebase, documentation, and project notes. Index files and directories, search by semantic meaning, track architectural decisions, and maintain a living project wiki that grows with your work. Use when: the user wants to understand a codebase, find where something is implemented, track architectural decisions, create project documentation, search across project files by meaning, or build a persistent knowledge base about a project.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/byte-rover>
31. `camsnap`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Capture frames or clips from RTSP/ONVIF cameras.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/camsnap>
32. `canvas`
   - 分类名称：非测试技能类 / 其他非测试相关
   - 功能作用：
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/canvas>
33. `capability-evolver`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Capability Evolver: continuously evolve and optimize Claude's own system prompt and behavioral instructions using the GEP (Genome Evolution Protocol). Analyze conversation patterns, identify capability gaps, and propose targeted prompt mutations that improve performance. Use when: the user wants to optimize Claude's behavior, improve prompt quality, fix repeated mistakes in system instructions, evolve Claude's capabilities over time, or run self-optimization cycles. Also use for 'Mad Dog Mode' where Claude continuously self-iterates on a task until optimal.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/capability-evolver>
34. `capability-evolver-pro`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Evolve and improve agent capabilities by analyzing conversation patterns, failures, and optimization opportunities.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/capability-evolver-pro>
35. `check-analytics`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/check-analytics>
36. `ci-cd`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：Automate builds, tests, and deployments across web, mobile, and backend applications.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/ci-cd>
37. `cicd-pipeline`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/cicd-pipeline>
38. `clawhub`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/clawhub>
39. `cloudflare-api`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/cloudflare-api>
40. `cloudflare-toolkit`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/cloudflare-toolkit>
41. `cloudflare-tunnel-manager`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/cloudflare-tunnel-manager>
42. `coding-agent`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Delegate coding tasks to Codex, Claude Code, or Pi agents via background process. Use when: (1) building/creating new features or apps, (2) reviewing PRs (spawn in temp dir), (3) refactoring large codebases, (4) iterative coding that needs file exploration. NOT for: simple one-liner fixes (just edit), reading code (use read tool), thread-bound ACP harness requests in chat (for example spawn/run Codex or Claude Code in a Discord thread; use sessions_spawn with runtime:"acp"), or any work in ~/clawd workspace (never spawn agents here). Claude Code: use --print --permission-mode bypassPermissions (no PTY). Codex/Pi/OpenCode: pty:true required.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/coding-agent>
43. `coding-agent-common`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Delegate coding tasks to Codex, Claude Code, or similar coding agents through shared background workflows.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/coding-agent-common>
44. `crash-fixer`
   - 分类名称：非测试技能类 / 其他非测试相关
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/crash-fixer>
45. `cross-browser-testing`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   - 功能作用：跨浏览器测试技能，用于验证产品在不同浏览器、操作系统、设备上的兼容性。当用户需要进行浏览器兼容性测试时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/cross-browser-testing>
46. `cs-analytics-tracking`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/cs-analytics-tracking>
47. `daily-report-writer`
...
48. `data-analyst`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Data Analyst Lite: read and analyze CSV and Excel files, perform data cleaning, statistical analysis, and generate visualizations including line charts, bar charts, histograms, and scatter plots. Use when: the user wants to analyze a spreadsheet or CSV file, get statistics on data, clean messy data, find patterns or trends, create charts, summarize a dataset, or perform exploratory data analysis.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/data-analyst>
49. `database-testing`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：数据库测试技能，用于验证数据库功能、性能、数据一致性和迁移测试。当用户需要进行SQL测试、数据验证、性能优化时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/database-testing>
50. `db-readonly`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/db-readonly>
51. `deerflow-super-agent-harness`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
...
52. `delegate-task`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Delegate tasks to OpenSpace — a full-stack autonomous worker for coding, DevOps, web research, and desktop automation, backed by an extensive MCP tool and skill library. Skills auto-improve through use, reducing token consumption over time. A cloud community lets agents share and collectively evolve reusable skills.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/delegate-task>
53. `diffs`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Use the diffs tool to produce real, shareable diffs (viewer URL, file artifact, or both) instead of manual edit summaries.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/diffs>
54. `discord`
   - 分类名称：非测试技能类 / 协作 / 工作流 / 消息
   - 功能作用：Discord ops via the message tool (channel=discord).
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/discord>
55. `docker-compose`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：Define multi-container applications with proper dependency handling, networking, and volume management.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/docker-compose>
56. `docker-diag`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：Advanced log analysis for Docker containers using signal extraction.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/docker-diag>
57. `docker-skill`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/docker-skill>
58. `e2e-test-orchestrator`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/e2e-test-orchestrator>
59. `e2e-testing`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   - 功能作用：Playwright 与 Cypress E2E 测试规范，涵盖目录结构、Page Object、CI 集成、视口与设备配置。当用户提到 E2E、端到端测试、Playwright、Cypress、集成测试时自动激活。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/e2e-testing>
60. `e2e-testing-patterns`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/e2e-testing-patterns>
61. `eightctl`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Control Eight Sleep pods (status, temperature, alarms, schedules).
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/eightctl>
62. `excel-xlsx`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/excel-xlsx>
63. `fastlane`
   - 分类名称：非测试技能类 / 其他非测试相关
   - 功能作用：iOS/macOS app automation — builds, signing, TestFlight, App Store via CLI
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/fastlane>
64. `feishu-doc`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
...
65. `feishu-drive`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/feishu-drive>
66. `feishu-perm`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   - 功能作用：Manage collaborators and permissions for Feishu docs, folders, and files with the `feishu_perm` tool.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/feishu-perm>
67. `feishu-wiki`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
...
69. `frontend-performance`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/frontend-performance>
70. `frontend-performance-audit`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：分析前端页面性能并输出结构化优化报告。适用于页面速度慢、lighthouse 指标差、core web vitals 不达标、首屏慢、交互卡顿、bundle 过大、阻塞渲染资源过多等场景。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/frontend-performance-audit>
71. `gemini`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Gemini CLI for one-shot Q&A, summaries, and generation.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/gemini>
72. `geo-testing`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：GEO (Generative Engine Optimization) testing skill for verifying AI search engine visibility, brand mentions, and citation optimization. Use when user needs GEO testing, AI search optimization verification, brand visibility in LLM responses, or checking how well content performs in generative AI search results.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/geo-testing>
73. `gh-issues`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/gh-issues>
74. `gifgrep`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Search GIF providers with CLI/TUI, download results, and extract stills/sheets.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/gifgrep>
75. `github`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
...
76. `github-actions`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/github-actions>
77. `gitlab`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：Avoid common GitLab CI/CD mistakes — rules gotchas, silent failures, and YAML merge traps.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/gitlab>
78. `gog`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Google Workspace CLI for Gmail, Calendar, Drive, Contacts, Sheets, and Docs.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/gog>
79. `goplaces`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/goplaces>
80. `grafana-api`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：Access Grafana dashboards, folders, data sources, annotations, and alerts through managed API authentication.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/grafana-api>
81. `grafana-lens`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/grafana-lens>
82. `gstack-qa`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/gstack-qa>
83. `healthcheck`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/healthcheck>
84. `helm`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/helm>
85. `himalaya`
   - 分类名称：非测试技能类 / 协作 / 工作流 / 消息
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/himalaya>
86. `html-to-pdf`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/html-to-pdf>
87. `image-edit`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   - 功能作用：Edit images with AI inpainting, outpainting, background removal, upscaling, and restoration tools.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/image-edit>
88. `image-handler`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/image-handler>
89. `imsg`
   - 分类名称：非测试技能类 / 协作 / 工作流 / 消息
   - 功能作用：iMessage/SMS CLI for listing chats, history, and sending messages via Messages.app.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/imsg>
90. `incident-fupan`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/incident-fupan>
91. `incident-response`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/incident-response>
92. `initial-traefik`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/initial-traefik>
93. `ios-simulator`
   - 分类名称：测试技能类 / APP / 移动端 / 终端测试
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/ios-simulator>
94. `jenkins`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/jenkins>
95. `jira`
   - 分类名称：非测试技能类 / 其他非测试相关
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/jira>
96. `k8s`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：Avoid common Kubernetes mistakes — resource limits, probe configuration, selector mismatches, and RBAC pitfalls.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/k8s>
97. `kafka`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/kafka>
98. `kibana`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/kibana>
99. `kubectl`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/kubectl>
100. `kubernetes-devops`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/kubernetes-devops>
101. `lh-video-gen`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/lh-video-gen>
102. `linear`
   - 分类名称：非测试技能类 / 其他非测试相关
   - 功能作用：Query and manage Linear issues, projects, and team workflows.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/linear>
103. `logging-observability`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/logging-observability>
104. `mantis-manager`
   - 分类名称：非测试技能类 / 其他非测试相关
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/mantis-manager>
105. `mcporter`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/mcporter>
106. `midscene-android-automation`
   - 分类名称：测试技能类 / APP / 移动端 / 终端测试
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/midscene-android-automation>
107. `mobile-appium-test`
   - 分类名称：测试技能类 / APP / 移动端 / 终端测试
   - 功能作用：Android UI automation testing using Appium with USB-connected real devices.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/mobile-appium-test>
108. `mobile-responsive`
   - 分类名称：测试技能类 / APP / 移动端 / 终端测试
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/mobile-responsive>
109. `mobile-testing`
   - 分类名称：测试技能类 / APP / 移动端 / 终端测试
   - 功能作用：移动端测试技能，用于验证iOS和Android应用的功能、性能、兼容性和用户体验。当用户需要进行APP测试、移动端功能验证时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/mobile-testing>
110. `model-usage`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/model-usage>
111. `monitoring`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：Set up observability for applications and infrastructure with metrics, logs, traces, and alerts.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/monitoring>
112. `mqtt-client`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：This is a simple client for connecting to an mqtt instance
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/mqtt-client>
113. `mysqladm`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
...
118. `node-connect`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/node-connect>
119. `notion`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Notion API for creating and managing pages, databases, and blocks.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/notion>
120. `obsidian`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Work with Obsidian vaults (plain Markdown notes) and automate via obsidian-cli.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/obsidian>
121. `openai-image-gen`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   - 功能作用：Batch-generate images via OpenAI Images API. Random prompt sampler + `index.html` gallery.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openai-image-gen>
122. `openai-whisper`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Local speech-to-text with the Whisper CLI (no API key).
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openai-whisper>
123. `openai-whisper-api`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Transcribe audio via OpenAI Audio Transcriptions API (Whisper).
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openai-whisper-api>
124. `openapi-spec`
   - 分类名称：测试技能类 / 接口测试 / API / Mock
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openapi-spec>
125. `openclaw-agent-browser`
   - 分类名称：非测试技能类 / 其他非测试相关
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openclaw-agent-browser>
126. `openclaw-api-tester`
   - 分类名称：测试技能类 / 接口测试 / API / Mock
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openclaw-api-tester>
127. `openclaw-control-center`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：面向 OpenClaw 的本地优先、安全优先控制中心。提供 agent 活动可视化、token 用量、协作链路、任务审批、记忆状态和控制面板能力，帮助把 OpenClaw 从黑盒变成可观测控制台。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openclaw-control-center>
128. `openclaw-log-analyzer`
   - 分类名称：非测试技能类 / 其他非测试相关
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openclaw-log-analyzer>
129. `openclaw-slides`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openclaw-slides>
130. `openhue`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Control Philips Hue lights and scenes via the OpenHue CLI.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openhue>
131. `openspace-self-evolving-agents`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Skill for using OpenSpace to make AI agents smarter, lower-cost, and self-evolving through skill sharing and collective intelligence.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/openspace-self-evolving-agents>
132. `oracle`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Best practices for using the oracle CLI (prompt + file bundling, engines, sessions, and file attachment patterns).
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/oracle>
133. `ordercli`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Foodora-only CLI for checking past orders and active order status (Deliveroo WIP).
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/ordercli>
134. `pdf-skill`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/pdf-skill>
135. `peekaboo`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Capture and automate macOS UI with the Peekaboo CLI.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/peekaboo>
136. `perf-test-suite`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/perf-test-suite>
137. `performance-profiler`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/performance-profiler>
138. `performance-testing`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：性能测试技能，用于验证系统性能、响应时间、吞吐量、资源使用率等。当用户需要进行压力测试、负载测试、稳定性测试时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/performance-testing>
139. `performance-tuning`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/performance-tuning>
140. `petclaw-1`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：PetClaw Calendar Skill: create calendar events on macOS using AppleScript, then open Calendar.app so the user can see the result. Use when: the user wants to add a schedule, create an event, book a meeting, or set a reminder.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/petclaw-1>
141. `petclaw-2`
   - 分类名称：非测试技能类 / 其他非测试相关
   - 功能作用：PetClaw AI News Skill: open the browser to search today's latest AI news, then summarize the results. Use when: the user wants to find, browse, or get a summary of the latest AI news or tech updates.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/petclaw-2>
142. `petclaw-image-gen`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   - 功能作用：PetClaw built-in image generation. Text-to-image and image-to-image via PetClaw API. Use when the user asks to generate, create, or draw an image, or provides reference images to create a new one.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/petclaw-image-gen>
143. `petclaw-video-gen`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   - 功能作用：PetClaw built-in video generation. Text-to-video and image-to-video via PetClaw API. Use when the user asks to generate, create, or animate a video, or provides reference images to create a video from them.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/petclaw-video-gen>
144. `petclaw-web-search`
   - 分类名称：非测试技能类 / 其他非测试相关
   - 功能作用：PetClaw Web Search: perform real-time web searches using PetClaw's built-in search API. Use when: the user wants to search the internet, look up current information, find news, research a topic, or get any information that may have changed since training data.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/petclaw-web-search>
145. `playwright-browser-automation`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/playwright-browser-automation>
146. `playwright-cli-openclaw`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/playwright-cli-openclaw>
147. `playwright-mcp`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/playwright-mcp>
148. `playwright-npx`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/playwright-npx>
149. `playwright-pro`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/playwright-pro>
150. `playwright-skill`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   - 功能作用：Complete browser automation with Playwright. Auto-detects dev servers, writes clean test scripts to /tmp. Test pages, fill forms, take screenshots, check responsive design, validate UX, test login flows, check links, automate any browser task. Use when user wants to test websites, automate browser interactions, validate web functionality, or perform any browser-based testing.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/playwright-skill>
151. `pls-audit-website`
   - 分类名称：非测试技能类 / 其他非测试相关
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/pls-audit-website>
152. `pls-seo-audit`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/pls-seo-audit>
153. `postgres-mcp-skill`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/postgres-mcp-skill>
154. `postman`
   - 分类名称：测试技能类 / 接口测试 / API / Mock
   - 功能作用：Build, test, and automate APIs with Postman collections, environments, and Newman CLI.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/postman>
155. `powerpoint-pptx`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/powerpoint-pptx>
156. `ppt-agent-workflow-san`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   - 功能作用：渐进交互式 PPT 生成工作流 skill。适合从主题、文章、报告或 briefing 出发，分阶段完成资料收集、结构搭建、逐页规划、中间稿评审与完整演示稿输出。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/ppt-agent-workflow-san>
157. `ppt-generator`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   - 功能作用：Professional PowerPoint presentation generator with modern design templates, charts, animations, and visual effects. Create stunning presentations with gradient backgrounds, data visualizations, icon systems, and corporate branding. Use when user needs professional PPT, presentation slides, visual reports, or data-driven slideshows.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/ppt-generator>
158. `pptx-generator`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/pptx-generator>
159. `prometheus`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/prometheus>
160. `promql-cli`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/promql-cli>
161. `prose`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：OpenProse VM skill pack. Activate on any `prose` command, .prose files, or OpenProse mentions; orchestrates multi-agent workflows.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/prose>
162. `qa-api-runner`
   - 分类名称：测试技能类 / 接口测试 / API / Mock
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-api-runner>
163. `qa-browser-tester`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   - 功能作用：Run exhaustive browser-based QA testing with headless Chromium to simulate real user journeys through a web app.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-browser-tester>
164. `qa-bug-triage`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-bug-triage>
165. `qa-patrol`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-patrol>
166. `qa-prd-analyzer`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 报告
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-prd-analyzer>
167. `qa-regression-planner`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 报告
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-regression-planner>
168. `qa-release-gate-checker`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 报告
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-release-gate-checker>
169. `qa-skill`
   - 分类名称：测试技能类 / APP / 移动端 / 终端测试
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-skill>
170. `qa-test-data-factory`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 报告
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-test-data-factory>
171. `qa-test-point-extractor`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 报告
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-test-point-extractor>
172. `qa-test-report-generator`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 报告
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-test-report-generator>
173. `qa-test-suite`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   - 功能作用：完整的 QA 测试技能包，包含 API 测试、UI 自动化、测试数据生成和缺陷跟踪功能
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-test-suite>
174. `qa-testcase-writer`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 报告
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-testcase-writer>
175. `qa-traceability-mapper`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 报告
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-traceability-mapper>
176. `qa-web-e2e-runner`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/qa-web-e2e-runner>
177. `rabbitmq-client-guide`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/rabbitmq-client-guide>
178. `react-performance`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：React and Next.js performance optimization patterns. Use when writing,
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/react-performance>
179. `regression-testing`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   - 功能作用：回归测试技能，用于验证新代码是否破坏了现有功能，确保系统稳定性。当用户需要进行回归测试、版本验证、发布前检查时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/regression-testing>
180. `research-paper-writer`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/research-paper-writer>
181. `sag`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：ElevenLabs text-to-speech with mac-style say UX.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/sag>
182. `security-audit-toolkit`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/security-audit-toolkit>
183. `security-auditor`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/security-auditor>
184. `security-scanner`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/security-scanner>
185. `security-testing`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：安全测试技能，用于验证系统安全性、漏洞扫描、渗透测试、安全审计等。当用户需要进行安全测试、漏洞检测、安全检查时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/security-testing>
186. `self-improving-agent`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Self-Improving Agent: continuously learn from every conversation and evolve your capabilities. After each session, extract insights, patterns, and preferences from the interaction and store them in a persistent memory file (~/.openclaw/self-memory.md). Automatically reference past learnings to improve future responses. Use when: the user wants Claude to remember their preferences, learn from mistakes, adapt to their working style, improve over time, or build a personalized AI experience. Also activate when starting a new session to load accumulated learnings.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/self-improving-agent>
187. `self-improving-agent-skill`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：基于对经验的持续学习，不断优化 Agent 能力。适用于完成重要任务后、出现错误时、会话结束时，或用户输入“自我进化”“总结经验”“从经验中学习”等指令时触发。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/self-improving-agent-skill>
188. `sensors-analytics-tracking`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/sensors-analytics-tracking>
189. `seo-optimizer`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/seo-optimizer>
190. `seo-testing`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：SEO测试技能，用于验证网页的SEO参数配置、TDK设置、搜索引擎优化等。当用户需要进行SEO测试、检查网页标题描述关键词、验证SEO配置时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/seo-testing>
191. `session-logs`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Search and analyze your own session logs (older/parent conversations) using jq.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/session-logs>
192. `shelly-seo-analyzer`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/shelly-seo-analyzer>
193. `sherpa-onnx-tts`
   - 分类名称：非测试技能类 / 其他非测试相关
   - 功能作用：Local text-to-speech via sherpa-onnx (offline, no cloud)
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/sherpa-onnx-tts>
194. `skill-auditor`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Security-first skill vetting for AI agents. Use before installing any skill from ClawHub, GitHub, or other sources. Checks for red flags, permission scope, and suspicious patterns.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/skill-auditor>
195. `skill-creator`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
...
196. `skill-discovery`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
   - 功能作用：Search for reusable skills across OpenSpace's local registry and cloud community. Reusing proven skills saves tokens, improves reliability, and extends your capabilities beyond built-in tools.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/skill-discovery>
197. `skill-vetter`
   - 分类名称：非测试技能类 / 开发 / GitHub / Agent 工具
...
198. `slack`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/slack>
199. `smart-weekly-report`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   - 功能作用：Generate structured weekly work reports from natural-language summaries of completed work, blockers, and next steps.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/smart-weekly-report>
200. `songsee`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Generate spectrograms and feature-panel visualizations from audio with the songsee CLI.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/songsee>
201. `sonoscli`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Control Sonos speakers (discover/status/play/volume/group).
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/sonoscli>
202. `sovereign-api-mock-generator`
   - 分类名称：测试技能类 / 接口测试 / API / Mock
   - 功能作用：Generates mock API servers from OpenAPI specs or examples. Realistic fake data, configurable delays, error simulation.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/sovereign-api-mock-generator>
203. `spotify-player`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Terminal Spotify playback/search via spogo (preferred) or spotify_player.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/spotify-player>
204. `sql-toolkit`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/sql-toolkit>
205. `star-office-ui`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：像素办公室看板一键化 skill。帮助快速部署可视化办公室界面，支持多 Agent 加入、状态展示、移动端查看和公网访问，适合演示、协作看板和状态展示场景。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/star-office-ui>
206. `stock-analysis`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Stock Analysis & Financial News: analyze stocks, ETFs, and cryptocurrencies using real-time market data from Yahoo Finance. Get price quotes, technical indicators, financial ratios, earnings data, and generate analysis reports. Use when: the user wants to check a stock price, analyze a company's financials, get investment research, understand a stock's performance, read an earnings report, get market news, compare multiple stocks, or analyze a portfolio.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/stock-analysis>
207. `summarize`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
...
212. `terraform-iac`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/terraform-iac>
213. `test-automation`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：测试自动化技能，用于构建和维护自动化测试框架、CI/CD集成、测试报告等。当用户需要建立自动化测试体系、持续集成时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/test-automation>
214. `test-generator`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/test-generator>
215. `test-master`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/test-master>
216. `test-patterns`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/test-patterns>
217. `test-runner`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   - 功能作用：Write and run tests across languages and frameworks for unit, integration, and end-to-end validation.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/test-runner>
218. `test-sentinel`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
   - 功能作用：Writes and runs tests (unit, integration, E2E), performs linting, and auto-fixes failures
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/test-sentinel>
219. `testflight`
   - 分类名称：测试技能类 / APP / 移动端 / 终端测试
   - 功能作用：Distribute iOS and macOS beta builds with TestFlight, tester management, and CI/CD automation.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/testflight>
220. `things-mac`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/things-mac>
221. `tmux`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Remote-control tmux sessions for interactive CLIs by sending keystrokes and scraping pane output.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/tmux>
222. `tracking-testing`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：埋点测试技能，用于验证数据埋点、事件追踪、用户行为统计等。当用户需要进行埋点测试、验证数据采集、检查事件触发时使用。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/tracking-testing>
223. `traefik`
   - 分类名称：测试技能类 / 测试支撑环境 / 可观测 / 平台
   - 功能作用：Avoid common Traefik mistakes — router priority, TLS configuration, Docker labels syntax, and middleware ordering.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/traefik>
224. `trello`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Manage Trello boards, lists, and cards via the Trello REST API.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/trello>
225. `ux-qa-gate`
   - 分类名称：测试技能类 / 功能测试 / 回归测试 / 巡检 / 缺陷
...
228. `video-gif-converter`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/video-gif-converter>
229. `video-stitcher`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/video-stitcher>
230. `visual-regression-testing`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   - 功能作用：Run visual regression testing for websites with screenshot comparison workflows and change detection for UI issues.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/visual-regression-testing>
231. `voice-call`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   - 功能作用：Start voice calls via the OpenClaw voice-call plugin.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/voice-call>
232. `wacli`
   - 分类名称：非测试技能类 / 协作 / 工作流 / 消息
   - 功能作用：Send WhatsApp messages to other people or search/sync WhatsApp history via the wacli CLI (not for normal user chats).
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/wacli>
233. `weather`
   - 分类名称：非测试技能类 / 办公 / 效率 / 通用工具
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/weather>
234. `web-access`
   - 分类名称：非测试技能类 / 其他非测试相关
   - 功能作用：所有联网操作必须通过此 skill 处理，包括搜索、网页抓取、登录后操作、网页交互和真实浏览器环境下的网络任务。适合需要稳定访问网页、读取动态内容和执行网页登录流程的场景。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/web-access>
235. `web-auto-analyzer`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：Automatically analyze websites for performance metrics and audit issues using Lighthouse.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/web-auto-analyzer>
236. `web-perf`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   - 功能作用：Analyzes web performance using Chrome DevTools MCP. Measures Core Web Vitals (FCP, LCP, TBT, CLS, Speed Index), identifies render-blocking resources, network dependency chains, layout shifts, caching issues, and accessibility gaps. Use when asked to audit, profile, debug, or optimize page load performance, Lighthouse scores, or site speed.
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/web-perf>
237. `web-screenshot`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化
   - 功能作用：🖼️ 任意URL全页面截图 + PDF导出工具。当用户要求截取网页、保存网页快照、截图存档、做QA对比、导出PDF时使用。支持百度/知乎/微信公众号/小红书等中文网站，自动等待JS渲染交付PNG/JPG/PDF。
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/web-screenshot>
238. `webperf`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/webperf>
239. `webperf-core-web-vitals`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/webperf-core-web-vitals>
240. `webperf-interaction`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/webperf-interaction>
241. `webperf-loading`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/webperf-loading>
242. `webperf-media`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/webperf-media>
243. `webperf-resources`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/webperf-resources>
244. `website-seo`
   - 分类名称：测试技能类 / 性能 / SEO / 安全 / 埋点
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/website-seo>
245. `weekly-report-writer`
   - 分类名称：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
...
248. `xurl`
   ...
   - GitHub 链接：<https://github.com/QA19816-glitch/QA-agent/tree/main/openclaw-skill/xurl>
