...
2. `add-analytics`
   ...
   - 所属大类：测试技能类 / 性能测试 / SEO测试 / 安全测试 / 埋点测试
...
4. `afrexai-qa-test-plan`
   ...
   - 所属大类：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 发布准入
...
23. `capability-evolver-pro`
   - 功能作用：>
   - 所属大类：非测试技能类 / 开发 / GitHub / Agent 工具
...
34. `daily-report-writer`
   - 功能作用：根据输入生成日报 Markdown 草稿并写入 reports 目录
   - 所属大类：非测试技能类 / 飞书 / 文档 / 知识库 / 媒体内容
...
41. `e2e-test-orchestrator`
   ...
   - 所属大类：测试技能类 / Web UI / E2E / 浏览器自动化测试
...
115. `playwright-browser-automation`
...
149. `self-improving-agent-skill`
...
150. `sensors-analytics-tracking`
...
161. `sovereign-api-mock-generator`
