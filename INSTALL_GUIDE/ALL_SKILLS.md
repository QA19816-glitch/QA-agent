...
2. `add-analytics`
   - 分类名称：测试技能类 / 性能测试 / SEO测试 / 安全测试 / 埋点测试
...
4. `afrexai-qa-test-plan`
   - 分类名称：测试技能类 / 需求分析 / 测试设计 / 用例 / 追踪 / 发布准入
...
35. `db-readonly`
   - 分类名称：测试技能类 / 测试支撑环境 / 数据库 / 日志 / 可观测 / 消息系统
...
41. `e2e-test-orchestrator`
   - 分类名称：测试技能类 / Web UI / E2E / 浏览器自动化测试
